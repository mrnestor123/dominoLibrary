...
public class MainMenuController implements Initializable {
    ...
    private void goToStudentsManagement(ActionEvent event) {
        try {
            ...
            window1.initStage(primaryStage,d);
    ...
    private void gotoLogin(ActionEvent event){
       ...
       login.setOnAction(e ->{
                ...
                d.addPlayer(p);
                Alert alert = new Alert(AlertType.CONFIRMATION, "You are about to create a player with name" + p.getName() + ".Do you want to continue?", ButtonType.YES, ButtonType.NO, ButtonType.CANCEL);
